...
#import "LE_3_ViewController.h"
#import "Clock_RightViewController.h"
#import "AppDelegate.h"
#import "RE_1_ViewController.h"
#import "TransitionViewController.h"

@interface LE_3_ViewController ()

@end

@implementation LE_3_ViewController
@synthesize image;
...
//            [image setCenter:self.view.center];
           ...
           // UIImage   *bgImage = [UIImage imageNamed:@"326ppi_10px_R.png"];
            UIImage   *bgImage = [UIImage imageNamed:@"326ppi_22px_R.png"];
            image = [[UIImageView alloc]initWithImage:bgImage];
            image.frame=CGRectMake(truncf(eX-ivhw/2),truncf(eY-ivhw/2) ,ivhw,ivhw);

            //image.frame=CGRectMake(0.0, 0.0, 5,5);
            //image.frame=CGRectMake(0.0, 0.0, 10,10);
           // [image setCenter:self.view.center];
            [self.view addSubview:image];
        }
    }
        ...
        if (screenWidth*scale == 768 && screenHeight*scale == 1024) {
            ...
            UIImage   *bgImage = [UIImage imageNamed:@"132ppi_5px_R.png"];
            image = [[UIImageView alloc]initWithImage:bgImage];
            image.frame=CGRectMake(truncf(eX),truncf(eY) ,5,5);
...
-(void)eLogic:(NSString *)directions{
    ...
    if(ans>=curInd-1){
        if(curInd < 4){
            ...
            [appDelegate.rightEyeResult setValue:@"Normal" forKey:@"etest"];
            
            NSLog(@"appDelegate-rightEyeResult:%@",[appDelegate.rightEyeResult valueForKey:@"etest"]);
            /*
