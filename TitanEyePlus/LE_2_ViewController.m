...
@interface LE_2_ViewController ()

@end

@implementation LE_2_ViewController
@synthesize image;
...
-(void)eLogic:(NSString *)directions{
    ...
    if(ans>=curInd-1){
        if(curInd < 4){
            ...
            LE_3_ViewController *controller;
            if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
                controller=[[LE_3_ViewController alloc]initWithNibName:@"LE_3_ViewController" bundle:nil];
                
            } else {
                controller=[[LE_3_ViewController alloc]initWithNibName:@"LE_3_ViewController_iPad" bundle:nil];
            }
