...
@interface RE_1_ViewController ()

@end

@implementation RE_1_ViewController
...
-(void)eLogic:(NSString *)directions{
    ...
    if(ans>=curInd-1){
        if(curInd < 4){
            ...
            RE_2_ViewController *controller;
            if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
                controller=[[RE_2_ViewController alloc]initWithNibName:@"RE_2_ViewController" bundle:nil];
                
            } else {
                controller=[[RE_2_ViewController alloc]initWithNibName:@"RE_2_ViewController_iPad" bundle:nil];
            }
