...
@interface RE_3_ViewController ()


@end

@implementation RE_3_ViewController
@synthesize image;
...
-(void)viewDidLoad{
    ...
    NSLog(@"screen size is %@",NSStringFromCGSize(screenSize));
    //view size
    CGFloat arrowX;
    CGFloat arrowY;
    CGFloat aw;
...
-(void)eLogic:(NSString *)directions{
    ...
    if(ans>=curInd-1){
        if(curInd < 4){
            ...
            [appDelegate.leftEyeResult setValue:@"Normal" forKey:@"etest"];
            /*
